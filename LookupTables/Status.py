# References: https://answers.microsoft.com/en-us/windows/forum/windows_vista-security/where-can-i-find-the-full-list-of-failure-reasons/d0269426-2183-4d99-8af0-cc009dee6658
table = {
    ...
    "0xC0000480": "The share is temporarily unavailable.",
    ...
    "0x4000000A": "{Redundant Read} To satisfy a read request, the  Windows NT operating system fault-tolerant file system successfully read the  requested data from a redundant copy. This was done because the file system  encountered a failure on a member of the fault-tolerant volume but was unable  to reassign the failing area of the device.",
    ...
    "0x401B00EC": "{Display Driver Recovered From Failure} The %hs  display driver has detected a failure and recovered from it. Some graphical  operations might have failed. The next time you restart the machine, a dialog  box appears, giving you an opportunity to upload data about this failure to  Microsoft.",
    ...
    "0x80000016": "{Verifying Disk} The media has changed and a verify  operation is in progress; therefore, no reads or writes can be performed to  the device, except those that are used in the verify operation.",
    "0x80000017": "{Too Much Information} The specified access control  list (ACL) contained more information than was expected.",
    "0x80000018": "This warning level status indicates that the  transaction state already exists for the registry subtree, but that a  transaction commit was previously aborted. The commit has NOT been completed  but has not been rolled back either; therefore, it can still be committed, if  needed.",
    ...
    "0x8000001C": "{Media Changed} The media has changed.",
    ...
    "0x80000020": "{Media Changed} The media might have changed.",
    ...
    "0x8000002B": "The application is attempting to run executable code  from the module %hs. This might be insecure. An alternative, %hs, is  available. Should the application use the secure module %hs?",
    "0x8000002C": "The application is loading executable code from the  module %hs. This is secure but might be incompatible with previous releases  of the operating system. An alternative, %hs, is available. Should the  application use the secure module %hs?",
    ...
    "0xC0000058": "Indicates a revision number that was encountered or  specified is not one that is known by the service. It might be a more recent  revision than the service is aware of.",
    "0xC0000059": "Indicates that two revision levels are incompatible.",
    "0xC000005A": "Indicates a particular security ID cannot be assigned  as the owner of an object.",
    "0xC000005B": "Indicates a particular security ID cannot be assigned  as the primary group of an object.",
    ...
    "0xC000005D": "A mandatory group cannot be disabled.",
    "0xC000005E": "No logon servers are currently available to service  the logon request.",
    "0xC000005F": "A specified logon session does not exist. It might  already have been terminated.",
    ...
    "0xC000006C": "When trying to update a password, this status  indicates that some password update rule has been violated. For example, the  password might not meet length criteria.",
    ...
    "0xC000006F": "The user account has time restrictions and cannot be  logged onto at this time.",
    "0xC0000070": "The user account is restricted so that it cannot be  used to log on from the source workstation.",
    "0xC0000071": "The user account password has expired.",
    "0xC0000072": "The referenced account is currently disabled and  cannot be logged on to.",
    "0xC0000073": "None of the information to be translated has been  translated.",
    "0xC0000074": "The number of LUIDs requested cannot be allocated with  a single allocation.",
    ...
    "0xC00000A3": "{Drive Not Ready} The drive is not ready for use; its  door might be open. Check drive %hs and make sure that a disk is inserted and  that the drive door is closed.",
    ...
    "0xC00000A6": "An attempt was made to open an anonymous-level token.  Anonymous tokens cannot be opened.",
    ...
    "0xC00000D3": "The number of active profiling objects is at the  maximum and no more can be started.",
    ...
    "0xC0000125": "The operation requested cannot be performed on the  specified group because it is a built-in special group.",
    "0xC0000126": "The operation requested cannot be performed on the  specified user because it is a built-in special user.",
    ...
    "0xC0000129": "Indicates a process has too many threads to perform  the requested action. For example, assignment of a primary token can be  performed only when a process has zero or one threads.",
    ...
    "0xC0000134": "On applicable Windows Server releases, the SAM  database is significantly out of synchronization with the copy on the domain  controller. A complete synchronization is required.",
    "0xC0000135": "{Unable To Locate Component} This application has  failed to start because %hs was not found. Reinstalling the application might  fix this problem.",
    ...
    "0xC000013B": "{Virtual Circuit Closed} The network transport on your  computer has closed a network connection. There might or might not be I/O  requests outstanding.",
    "0xC000013C": "{Virtual Circuit Closed} The network transport on a  remote computer has closed a network connection. There might or might not be  I/O requests outstanding.",
    "0xC000013D": "{Insufficient Resources on Remote Computer} The remote  computer has insufficient resources to complete the network request. For  example, the remote computer might not have enough available memory to carry  out the request at this time.",
    ...
    "0xC0000156": "The maximum number of secrets that can be stored in a  single system was exceeded. The length and number of secrets is limited to  satisfy U.S. State Department export restrictions.",
    ...
    "0xC000015B": "A user has requested a type of logon (for example,  interactive or network) that has not been granted. An administrator has  control over who can logon interactively and through the network.",
    ...
    "0xC000015E": "A domain server has an incorrect configuration.",
    ...
    "0xC000018B": "On applicable Windows Server releases, the SAM  database does not have a computer account for this workstation trust  relationship.",
    ...
    "0xC0000190": "The network logon failed. This might be because the  validation authority cannot be reached.",
    ...
    "0xC000019E": "Short name settings cannot be changed on this volume  due to the global registry setting.",
    ...
    "0xC0000219": "{Unexpected Failure in DebugActiveProcess} An  unexpected failure occurred while processing a DebugActiveProcess API  request. Choosing OK will terminate the process, and choosing Cancel will  ignore the error.",
    ...
    "0xC0000222": "{Delayed Write Failed} Windows was unable to save all  the data for the file %hs. The data has been lost. This error might be caused  by a failure of your computer hardware or network connection. Try to save  this file elsewhere.",
    "0xC0000223": "The parameters passed to the server in the  client/server shared memory window were invalid. Too much data might have  been put in the shared memory window.",
    ...
    "0xC00002C2": "{System Standby Failed} The driver %hs does not  support standby mode. Updating this driver allows the system to go to standby  mode.",
    ...
    "0xC00002C8": "{Virtual Memory Minimum Too Low} Your system is low on  virtual memory. Windows is increasing the size of your virtual memory paging  file. During this process, memory requests for some applications might be  denied. For more information, see Help.",
    ...
    "0xC0000300": "This operation is not supported on a computer running  Windows Server 2003 operating system for Small Business Server.",
    ...
    "0xC000030B": "Copy protection error—The region setting of the drive  might be permanent.",
    ...
    "0xC0000357": "The machine account was created prior to Windows NT  4.0 operating system. The account needs to be recreated.",
    ...
    "0xC0000366": "The device encountered an error while applying power  or reading the device configuration. This might be caused by a failure of  your hardware or by a poor connection.",
    ...
    "0xC0000389": "The smart card certificate used for authentication has  been revoked. Contact your system administrator. There might be additional  information in the event log.",
    ...
    "0xC0000446": "Indicates a particular Security ID cannot be assigned  as the label of an object.",
    ...
    "0xC0000466": "The file server is temporarily unavailable.",
    ...
    "0xC000A080": "{Delayed Write Failed} Windows was unable to save all  the data for the file %hs; the data has been lost. This error might be caused  by network connectivity issues. Try to save this file elsewhere.",
    ...
    "0xC000A082": "{Delayed Write Failed} Windows was unable to save all  the data for the file %hs; the data has been lost. This error might be caused  if the device has been removed or the media is write-protected.",
    ...
    "0xC000A2A3": "Offload read operations cannot be performed on:  Compressed files,  Sparse files,  Encrypted files,  File system metadata files",
    "0xC000A2A4": "Offload write operations cannot be performed on:  Compressed files,  Sparse files,  Encrypted files,  File system metadata files",
    ...
    "0xC0150019": "The identity string is malformed. This might be due to  a trailing comma, more than two unnamed attributes, a missing attribute name,  or a missing attribute value.",
    ...
    "0xC0190024": "A miniversion can be opened only in the context of the  transaction that created it.",
    ...
    "0xC0190044": "This file is open for modification in an unresolved  transaction and can be opened for execute only by a transacted reader.",
    ...
    "0xC0190060": "The handle is no longer properly associated with its  transaction.  It might have been opened in a transactional resource manager  that was subsequently forced to restart.  Please close the handle and open a  new one.",
...
def getDescription(StatusCode):
    return table.get(StatusCode)
